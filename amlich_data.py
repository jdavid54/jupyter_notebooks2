...
TIETKHI = ('Xuân phân', 'Thanh minh', 'Cốc vũ', 'Lập hạ', 'Tiểu mãn', 'Mang chủng', 'Hạ chí', 'Tiểu thử', 'Đại thử', 'Lập thu', 'Xử thử', 'Bạch lộ', 'Thu phân', 'Hàn lộ', 'Sương giáng', 'Lập đông', 'Tiểu tuyết', 'Đại tuyết', 'Đông chí', 'Tiểu hàn', 'Đại hàn', 'Lập xuân', 'Vũ Thủy', 'Kinh trập')
# add principal terms
...
for k in range(len(terms)):
    s = terms_dates[k].split('/')
    terms_int.append((int(s[0]),int(s[1])))
'''
terms_int = [(6, 1), (21, 1), (5, 2), (19, 2), (6, 3), (21, 3), (5, 4), (21, 4), (6, 5), (22, 5), (6, 6), (22, 6), (8, 7), (23, 7), (8, 8), (24, 8), (8, 9), (24, 9), (9, 10), (24, 10), (8, 11), (23, 11), (8, 12), (22, 12)]
# longitude soleil
...
def terms_in_month(month):
    # show all terms in month
    for k in range(len(terms)):
        if month==terms_int[k][1]:
            print(terms_int[k][0],terms[k],terms_vi[k])
            
def which_terms(day,month):
    
    for k in range(len(terms)):
        if month==terms_int[k][1] and day==terms_int[k][0]:
            print(f'{day}/{month} : ',terms[k],terms_vi[k])
            break
    # if day/month is not a term, show all the terms in month
    print(f'Today : {day}/{month}')
    terms_in_month(month)
...
class OutputOptions():
    ...
    def __repr__(self) -> str:
        return 'fontSize='+self.fontSize+' - tableWidth='+self.tableWidth
